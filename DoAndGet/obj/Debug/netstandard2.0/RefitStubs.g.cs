...
namespace DoAndGet.Interfaces
{
    ...
    partial class AutoGeneratedIWebServices : IWebServices
    {
        ...
        /// <inheritdoc />
        Task<ImageResponce> IWebServices.UploadProfileImage(StreamPart stream, string token)
        {
            var arguments = new object[] { stream, token };
            var func = requestBuilder.BuildRestResultFuncForMethod("UploadProfileImage", new Type[] { typeof(StreamPart), typeof(string) });
