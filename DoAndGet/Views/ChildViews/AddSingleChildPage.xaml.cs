...
{
    public partial class AddSingleChildPage : ContentPage
    {
        AddSingleChildPageModel addSingleChildPageModel;
        public AddSingleChildPage()
        {
            InitializeComponent();
            BindingContext = addSingleChildPageModel = new AddSingleChildPageModel();
