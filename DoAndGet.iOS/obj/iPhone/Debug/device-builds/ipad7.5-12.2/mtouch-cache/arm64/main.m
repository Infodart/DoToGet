...
extern void *mono_aot_module_DoAndGet_iOS_info;
extern void *mono_aot_module_mscorlib_info;
extern void *mono_aot_module_DoAndGet_info;
...
extern void *mono_aot_module_Nito_AsyncEx_Context_info;
extern void *mono_aot_module_Nito_Disposables_info;
extern void *mono_aot_module_System_Collections_Immutable_info;
extern void *mono_aot_module_Nito_AsyncEx_Tasks_info;
...
extern void *mono_aot_module_FFImageLoading_Forms_Platform_info;
...
{
	mono_aot_register_module (mono_aot_module_DoAndGet_iOS_info);
	mono_aot_register_module (mono_aot_module_mscorlib_info);
	mono_aot_register_module (mono_aot_module_DoAndGet_info);
	...
	mono_aot_register_module (mono_aot_module_Nito_AsyncEx_Context_info);
	mono_aot_register_module (mono_aot_module_Nito_Disposables_info);
	mono_aot_register_module (mono_aot_module_System_Collections_Immutable_info);
	mono_aot_register_module (mono_aot_module_Nito_AsyncEx_Tasks_info);
	...
	mono_aot_register_module (mono_aot_module_FFImageLoading_Forms_Platform_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "DoAndGet.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
