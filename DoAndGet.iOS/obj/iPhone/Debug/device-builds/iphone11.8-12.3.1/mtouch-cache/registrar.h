...
@class DoToGet_iOS_Renderer_SpaceNavigationPageRenderer;
...
@class DoAndGet_iOS_Renderer_MyEntryRenderer;
@class Xamarin_Forms_Platform_iOS_FrameRenderer;
@class DoAndGet_iOS_Renderer_MaterialFrameRenderer;
@class DoAndGet_iOS_Renderer_GradientViewRenderer;
@class Xamarin_Forms_Platform_iOS_PickerRendererBase_1;
@class Xamarin_Forms_Platform_iOS_PickerRenderer;
@class DoAndGet_iOS_Renderer_MyPickerRenderer;
...
@interface DoToGet_iOS_Renderer_SpaceNavigationPageRenderer : Xamarin_Forms_Platform_iOS_NavigationRenderer {
}
	-(id) init;
@end
...
@interface DoAndGet_iOS_Renderer_MyEntryRenderer : Xamarin_Forms_Platform_iOS_EntryRenderer {
}
	-(id) init;
@end
...
@interface DoAndGet_iOS_Renderer_MaterialFrameRenderer : Xamarin_Forms_Platform_iOS_FrameRenderer {
}
	-(void) drawRect:(CGRect)p0;
	-(id) init;
@end

@interface DoAndGet_iOS_Renderer_GradientViewRenderer : Xamarin_Forms_Platform_iOS_VisualElementRenderer_1 {
}
	-(void) drawRect:(CGRect)p0;
	-(id) init;
@end
...
@interface DoAndGet_iOS_Renderer_MyPickerRenderer : Xamarin_Forms_Platform_iOS_PickerRenderer {
}
	-(id) init;
@end
